...
#include "src/models/Forms/CreateContestForm/createcontestform.h"
...
void Register::registerTypes() const {
    ...
    qmlRegisterType<LoginForm>("models", 1, 0, "LoginForm");
    qmlRegisterType<SignUpForm>("models", 1, 0, "SignUpForm");
    qmlRegisterType<CreateContestForm>("models", 1, 0, "CreateContestForm");
